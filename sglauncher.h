...
guint wengine, order=0, showweb=1, showcmd=1, showcalc=1, showda=1, showofd=1, useiconview=0,
	...
	ignorenodisplay=1, ignoreterminal=0, ignoreonlyshowin=0, hidewindeco=0, forceinstance=0,
	singleinstance=0, showqa=1;
...
*xdg_box, *xdg_row, *wshowofd, *wsingleinstance, *wshowqa;
